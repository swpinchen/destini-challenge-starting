...
class StoryBrain {
  ...
  void nextStory(int choiceNumber) {
    ...
    switch(_storyNumber) {
      case 0 : { (choiceNumber == 1) ? _storyNumber = 2 : _storyNumber = 1; } break;
      case 1 : { (choiceNumber == 1) ? _storyNumber = 2 : _storyNumber = 3; } break;
      case 2 : { (choiceNumber == 1) ? _storyNumber = 5 : _storyNumber = 4; } break;
